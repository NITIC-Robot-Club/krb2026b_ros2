...
state オブジェクト23 {
    ...
    オブジェクト23_リングどかし --> オブジェクト23_移動 : set_pose(x = 2.05)
...
state オブジェクト45 {
    ...
    オブジェクト45_リングどかし --> オブジェクト45_移動 : set_pose(x = 2.45)
