...
state オブジェクト01 {
    ...
    オブジェクト01_旋回 --> オブジェクト01_射出 : set_joint_position(collector_arm_left = 0.0, collector_arm_right = 0.0, collector_hand_left = 0.0, collector_hand_right = 0.0, belt_launcher = 0.5)
    オブジェクト01_射出 --> [*]
}
