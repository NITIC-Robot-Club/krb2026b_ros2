...
state オブジェクト23 {
    ...
    オブジェクト23_保持準備 --> オブジェクト23_移動 : set_pose(x = 1.7, y = 0.5, yaw = 180.0)
    ...
    オブジェクト23_装填完了 --> オブジェクト23_旋回 : set_pose(x = 1.7, y = 0.5, yaw = 0.0)
...
state オブジェクト45 {
    ...
    オブジェクト45_保持準備 --> オブジェクト45_移動 : set_pose(x = 1.7, y = 0.5, yaw = 180.0)
    ...
    オブジェクト45_装填完了 --> オブジェクト45_旋回 : set_pose(x = 1.7, y = 0.5, yaw = 0.0)
